...
function calculateColemanLiau() {
  ...
  const colemanLiauIndex = calculateColemanLiauScore(text);
  document.getElementById('colemanLiauResult').innerText = `Coleman-Liau Index: ${colemanLiauIndex.toFixed(2)}`;
}
  ...
  function clearText() {
    ...
    document.getElementById('colemanLiauResult').innerText = 'Coleman-Liau Index will be displayed here.';
  }
  function calculateColemanLiauScore(text) {
    const colemanLiauIndex = getScores(text).colemanLiauIndex;
