function textAreaAdjust(t) {
  (t.style.height = "1px"), (t.style.height = 22 + t.scrollHeight + "px");
}
function debounce(i, o, a) {
  ...
  return function () {
    var t = this,
      e = arguments,
      n = function () {
        (s = null), a || i.apply(t, e);
      },
      r = a && !s;
    clearTimeout(s), (s = setTimeout(n, o)), r && i.apply(t, e);
  };
}
function findObjectByKey(t, e, n) {
  for (var r = 0; r < t.length; r++) if (t[r][e] === n) return t[r];
  return null;
}
function url_domain(t) {
  var e = document.createElement("a");
  return (e.href = t), e.hostname.replace("www.", "");
}
...
function GraphemeSplitter() {
  function a(t, e) {
    return (
      55296 <= t.charCodeAt(e) &&
      t.charCodeAt(e) <= 56319 &&
      56320 <= t.charCodeAt(e + 1) &&
      t.charCodeAt(e + 1) <= 57343
    );
  }
  function s(t, e) {
    e === undefined && (e = 0);
    ...
    if (55296 <= n && n <= 56319 && e < t.length - 1) {
      var r = n;
      return 56320 <= (i = t.charCodeAt(e + 1)) && i <= 57343
        ? 1024 * (r - 55296) + (i - 56320) + 65536
        : r;
    }
    if (56320 <= n && n <= 57343 && 1 <= e) {
      var i = n;
      return 55296 <= (r = t.charCodeAt(e - 1)) && r <= 56319
        ? 1024 * (r - 55296) + (i - 56320) + 65536
        : i;
    }
    return n;
  ...
  function u(t, e, n) {
    ...
    if (
      1 < a &&
      r.slice(1, a).every(function (t) {
        return t == h;
      }) &&
      -1 == [h, x, j].indexOf(t)
    )
      return A;
    var s = r.lastIndexOf(p);
    if (
      0 < s &&
      r.slice(1, s).every(function (t) {
        return t == p;
      }) &&
      -1 == [w, p].indexOf(i)
    )
    ...
    if (i == d || i == c || i == f)
      return o == E &&
        ...
        ? A
        : L;
    if (o == d || o == c || o == f) return L;
    if (i == v && (o == v || o == b || o == g || o == k)) return T;
    if (!((i != g && i != b) || (o != b && o != y))) return T;
    if ((i == k || i == y) && o == y) return T;
    if (o == h || o == S) return T;
    if (o == m) return T;
    if (i == w) return T;
    var u = -1 != r.indexOf(h) ? r.lastIndexOf(h) - 1 : r.length - 2;
    return -1 != [x, j].indexOf(r[u]) &&
      r.slice(u + 1, -1).every(function (t) {
        return t == h;
      }) &&
      o == E
      ? T
  ...
  return (
    (this.nextBreak = function (t, e) {
      if ((e === undefined && (e = 0), e < 0)) return 0;
      if (e >= t.length - 1) return t.length;
      for (var n = l(s(t, e)), r = [], i = e + 1; i < t.length; i++)
        if (!a(t, i - 1)) {
          var o = l(s(t, i));
          if (u(n, r, o)) return i;
          r.push(o);
    ...
    (this.splitGraphemes = function (t) {
      for (var e, n = [], r = 0; (e = this.nextBreak(t, r)) < t.length; )
        n.push(t.slice(r, e)), (r = e);
    ...
    (this.iterateGraphemes = function (n) {
      var r = 0,
        t = {
          next: function () {
            var t, e;
            return (e = this.nextBreak(n, r)) < n.length
              ? ((t = n.slice(r, e)), (r = e), { value: t, done: !1 })
              : r < n.length
              ? ((t = n.slice(r)), (r = n.length), { value: t, done: !1 })
    ...
    (this.countGraphemes = function (t) {
      for (var e, n = 0, r = 0; (e = this.nextBreak(t, r)) < t.length; )
        (r = e), n++;
...
(function () {
  ...
  (function () {
    (function () {
        ...
        (o = y.matches),
          ...
          (e = y.fire =
            function (t, e, n) {
              var r;
              return (
                (r = new i(e, { bubbles: !0, cancelable: !0, detail: n })),
                t.dispatchEvent(r),
                !r.defaultPrevented
              );
            }),
          ...
          (y.ajax = function (n) {
            ...
            return (
              ...
              (r = t(n, function () {
                ...
                return (
                  (e = a(
                    null != (t = r.response) ? t : r.responseText,
                    r.getResponseHeader("Content-Type")
                  )),
                  2 === Math.floor(r.status / 100)
                    ? "function" == typeof n.success &&
                      n.success(e, r.statusText, r)
                    : "function" == typeof n.error &&
                      n.error(e, r.statusText, r),
                  "function" == typeof n.complete
                    ? n.complete(r, r.statusText)
                    : void 0
                );
              })),
              !(null != n.beforeSend && !n.beforeSend(r, n)) &&
                (r.readyState === XMLHttpRequest.OPENED
                  ? r.send(n.data)
                  : void 0)
            );
          }),
      ...
      function () {
        ...
        (i = y.matches),
            ...
            return (
              ...
              n.forEach(function (e) {
                if (e.name && !e.disabled)
                  return i(e, "select")
                    ? o(e.options).forEach(function (t) {
                        if (t.selected)
                          return r.push({ name: e.name, value: t.value });
                      })
                    : e.checked ||
          ...
          (y.formElements = function (t, e) {
            return i(t, "form")
              ? o(t.elements).filter(function (t) {
                  return i(t, e);
                })
      ...
      function () {
        var n, r, i, o, a, s, e, u, l, c, f;
        (l = y.matches),
          (u = y.getData),
          (c = y.setData),
          (f = y.stopEverything),
          (e = y.formElements),
          (y.handleDisabledElement = function (t) {
          ...
          (y.enableElement = function (t) {
            ...
            return (
              ...
              l(e, y.linkDisableSelector)
                ? s(e)
                : l(e, y.buttonDisableSelector) || l(e, y.formEnableSelector)
                ? o(e)
                : l(e, y.formSubmitSelector)
                ? a(e)
                : void 0
            );
          }),
          (y.disableElement = function (t) {
            ...
            return (
              ...
              l(e, y.linkDisableSelector)
                ? i(e)
                : l(e, y.buttonDisableSelector) || l(e, y.formDisableSelector)
                ? n(e)
                : l(e, y.formSubmitSelector)
                ? r(e)
                : void 0
          ...
          (o = function (t) {
            ...
            return (
              null != (e = u(t, "ujs:enable-with")) &&
                (l(t, "button") ? (t.innerHTML = e) : (t.value = e),
        ...
        (h = y.matches),
          ...
          (y.handleRemote = function (t) {
            ...
            return (
              !d((i = this)) ||
              (l(i, "ajax:before")
                ? ((s = i.getAttribute("data-with-credentials")),
                  (r = i.getAttribute("data-type") || "script"),
                  h(i, y.formSubmitSelector)
                    ? ((e = c(i, "ujs:submit-button")),
                      (o = c(i, "ujs:submit-button-formmethod") || i.method),
                      (a =
                        c(i, "ujs:submit-button-formaction") ||
                        i.getAttribute("action") ||
                        location.href),
                      "GET" === o.toUpperCase() && (a = a.replace(/\?.*$/, "")),
                      "multipart/form-data" === i.enctype
                        ? ((n = new FormData(i)),
                          null != e && n.append(e.name, e.value))
                        : (n = p(i, e)),
                      m(i, "ujs:submit-button", null),
                      m(i, "ujs:submit-button-formmethod", null),
                      m(i, "ujs:submit-button-formaction", null))
                    : h(i, y.buttonClickSelector) || h(i, y.inputChangeSelector)
                    ? ((o = i.getAttribute("data-method")),
                      (a = i.getAttribute("data-url")),
                      (n = p(i, i.getAttribute("data-params"))))
                    : ((o = i.getAttribute("data-method")),
                      (a = y.href(i)),
                  ...
                  u({
                    ...
                    beforeSend: function (t, e) {
                      return l(i, "ajax:beforeSend", [t, e])
                        ? l(i, "ajax:send", [t])
                        : (l(i, "ajax:stopped"), !1);
                    },
                    success: function () {
                      var t;
                      return (
                        (t = 1 <= arguments.length ? b.call(arguments, 0) : []),
                        l(i, "ajax:success", t)
                      );
                    },
                    error: function () {
      ...
      function () {
        var t, r, e, n, i, o, a, s, u, l, c, f, d, h;
        (o = y.fire),
          (e = y.delegate),
          (s = y.getData),
          (t = y.$),
          (h = y.refreshCSRFTokens),
          (r = y.CSRFProtection),
          (i = y.enableElement),
          (n = y.disableElement),
          (l = y.handleDisabledElement),
          (u = y.handleConfirm),
          (d = y.handleRemote),
          (a = y.formSubmitButtonClick),
          (c = y.handleMetaClick),
          (f = y.handleMethod),
          ...
          (y.start = function () {
            ...
            return (
              window.addEventListener("pageshow", function () {
                return (
                  t(y.formEnableSelector).forEach(function (t) {
              ...
              e(document, y.linkDisableSelector, "ajax:complete", i),
              e(document, y.linkDisableSelector, "ajax:stopped", i),
              e(document, y.buttonDisableSelector, "ajax:complete", i),
              e(document, y.buttonDisableSelector, "ajax:stopped", i),
              e(document, y.linkClickSelector, "click", l),
              e(document, y.linkClickSelector, "click", u),
              e(document, y.linkClickSelector, "click", c),
              e(document, y.linkClickSelector, "click", n),
              e(document, y.linkClickSelector, "click", d),
              e(document, y.linkClickSelector, "click", f),
              e(document, y.buttonClickSelector, "click", l),
              e(document, y.buttonClickSelector, "click", u),
              e(document, y.buttonClickSelector, "click", n),
              e(document, y.buttonClickSelector, "click", d),
              e(document, y.inputChangeSelector, "change", l),
              e(document, y.inputChangeSelector, "change", u),
              e(document, y.inputChangeSelector, "change", d),
              e(document, y.formSubmitSelector, "submit", l),
              e(document, y.formSubmitSelector, "submit", u),
              e(document, y.formSubmitSelector, "submit", d),
              e(document, y.formSubmitSelector, "submit", function (t) {
                return setTimeout(function () {
                  return n(t);
                }, 13);
              }),
              e(document, y.formSubmitSelector, "ajax:send", n),
              e(document, y.formSubmitSelector, "ajax:complete", i),
              e(document, y.formInputClickSelector, "click", l),
              e(document, y.formInputClickSelector, "click", u),
              e(document, y.formInputClickSelector, "click", a),
    ...
    return (function (n) {
      ...
      function (t, e) {
        ...
        function o(t, e, n) {
          ...
          u.initEvent(e, o || !0, a || !0), (u.detail = s || {});
          try {
            (t.disabled = !1), t.dispatchEvent(u);
          } finally {
            t.disabled = i;
          }
          return u;
              ...
              l(r, [
                {
                  ...
                  value: function (r) {
                    var i = this;
                    a.a.create(this.file, function (t, e) {
                      if (t) r(t);
                      else {
                        var n = new s.a(i.file, e, i.url);
                        o(
                          i.delegate,
        ...
        function a(t) {
          ...
          if (e.hasAttribute(d)) t.preventDefault();
            ...
            r.length &&
              ...
              r.forEach(u),
              n.start(function (t) {
                e.removeAttribute(d), t ? r.forEach(l) : s(e);
              }));
          }
        }
        function s(t) {
      ...
      function (t, e, n) {
        ...
        var i = n(5),
          ...
          s = "input[type=file][data-direct-upload-url]:not([disabled])",
          u = (function () {
            function e(t) {
              r(this, e),
                (this.form = t),
                (this.inputs = Object(o.c)(t, s).filter(function (t) {
            ...
            return (
              a(e, [
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    var n =
                      1 < arguments.length && void 0 !== e ? arguments[1] : {};
            ...
            return (
              a(n, [
                  ...
                  value: function (n) {
                    ...
                    (i.type = "hidden"),
                      ...
                      this.directUpload.create(function (t, e) {
                        t
                          ? (i.parentNode.removeChild(i), r.dispatchError(t))
                          : (i.value = e.signed_id),
                          r.dispatch("end"),
                          n(t);
                      });
                ...
                },
                {
                  key: "dispatchError",
                  value: function (t) {
                    this.dispatch("error", { error: t }).defaultPrevented ||
                      alert(t);
                  },
                },
                {
      ...
      function (t) {
        ...
        (e = function (c) {
          ...
          function r(t) {
            ...
            for (e = 64; e <= s; e += 64) l(u, f(t.substring(e - 64, e)));
            for (
              n = (t = t.substring(e - 64)).length,
          ...
          function i(t) {
            var e,
              ...
              s = t.length,
              u = [1732584193, -271733879, -1732584194, 271733878];
            for (e = 64; e <= s; e += 64) l(u, d(t.subarray(e - 64, e)));
            for (
          ...
          return (
            ...
            (p.prototype._finish = function (t, e) {
              ...
              if (((t[o >> 2] |= 128 << (o % 4 << 3)), 55 < o))
                for (l(this._hash, t), o = 0; o < 16; o += 1) t[o] = 0;
            ...
            (p.ArrayBuffer.prototype.append = function (t) {
              var e,
                n = u(this._buff.buffer, t, !0),
                r = n.length;
              for (this._length += t.byteLength, e = 64; e <= r; e += 64)
                l(this._hash, d(n.subarray(e - 64, e)));
              return (
                (this._buff =
                  e - 64 < r
            ...
            (p.ArrayBuffer.prototype.getState = function () {
              ...
              return (t.buff = s(t.buff)), t;
            }),
            (p.ArrayBuffer.prototype.setState = function (t) {
              return (
                (t.buff = e(t.buff, !0)), p.prototype.setState.call(this, t)
              );
            }),
      ...
      function (t, e, n) {
        ...
        var r = (function () {
          ...
          i = (function () {
            function a(t) {
              var e = this;
              s(this, a), (this.blob = t), (this.file = t.file);
  ...
  (function (t) {
    ...
    function u(t) {
      var e,
        ...
        i,
        o = t.className + " ";
      if (((o += t.parentNode ? t.parentNode.className : ""), (n = k.exec(o))))
        return _(n[1]) ? n[1] : "no-highlight";
      for (e = 0, r = (o = o.split(/\s+/)).length; e < r; e++)
        if (s((i = o[e])) || _(i)) return i;
    }
    function n(t) {
      var e,
        n = {},
      ...
      return (
        (function i(t, e) {
          for (var n = t.firstChild; n; n = n.nextSibling)
            3 === n.nodeType
              ? (e += n.nodeValue.length)
              : 1 === n.nodeType &&
                (r.push({ event: "start", offset: e, node: n }),
                (e = i(n, e)),
                f(n).match(/br|hr|img|input/) ||
                  r.push({ event: "stop", offset: e, node: n }));
          return e;
        })(t, 0),
        r
      );
    ...
    function c(t, e, n) {
      ...
      function i(t) {
        function e(t) {
          return (
            " " + t.nodeName + '="' + C(t.value).replace('"', "&quot;") + '"'
          );
        }
        u += "<" + f(t) + v.map.call(t.attributes, e).join("") + ">";
      }
      function o(t) {
        u += "</" + f(t) + ">";
      }
      function a(t) {
        ("start" === t.event ? i : o)(t.node);
      }
      for (var s = 0, u = "", l = []; t.length || e.length; ) {
        var c = r();
        if (
          ((u += C(n.substring(s, c[0].offset))), (s = c[0].offset), c === t)
        ) {
          for (
            l.reverse().forEach(o);
            a(c.splice(0, 1)[0]),
              (c = r()) === t && c.length && c[0].offset === s;

          );
          l.reverse().forEach(i);
        } else
          "start" === c[0].event ? l.push(c[0].node) : l.pop(),
            a(c.splice(0, 1)[0]);
      }
      return u + C(n.substr(s));
    }
    function d(e) {
      return (
        e.v &&
    ...
    function T(o) {
      ...
      function s(t, e) {
        return new RegExp(a(t), "m" + (o.cI ? "i" : "") + (e ? "g" : ""));
      }
      function u(e, t) {
        if (!e.compiled) {
          if (((e.compiled = !0), (e.k = e.k || e.bK), e.k)) {
            var r = {},
              n = function (n, t) {
                o.cI && (t = t.toLowerCase()),
                  t.split(" ").forEach(function (t) {
                    var e = t.split("|");
                    r[e[0]] = [n, e[1] ? Number(e[1]) : 1];
                  });
              };
            "string" == typeof e.k
              ? n("keyword", e.k)
              : b(e.k).forEach(function (t) {
                  n(t, e.k[t]);
                }),
              (e.k = r);
          }
          (e.lR = s(e.l || /\w+/, !0)),
            t &&
              ...
              e.e && (e.eR = s(e.e)),
              (e.tE = a(e.e) || ""),
              e.eW && t.tE && (e.tE += (e.e ? "|" : "") + t.tE)),
            e.i && (e.iR = s(e.i)),
            null == e.r && (e.r = 1),
            e.c || (e.c = []),
            (e.c = Array.prototype.concat.apply(
              [],
              e.c.map(function (t) {
                return d("self" === t ? e : t);
              })
    ...
    function L(t, e, n, r) {
      function o(t, e) {
        var n, r;
        for (n = 0, r = e.c.length; n < r; n++)
          if (j(e.c[n].bR, t)) return e.c[n];
      }
      function a(t, e) {
        if (j(t.eR, e)) {
      ...
      function i(t, e) {
        var n = p.cI ? e[0].toLowerCase() : e[0];
        return t.k.hasOwnProperty(n) && t.k[n];
      }
      function u(t, e, n, r) {
        var i = '<span class="' + (r ? "" : q.classPrefix);
        return (i += t + '">') + e + (n ? "" : O);
      }
      function l() {
        var t, e, n, r;
        if (!v.k) return C(g);
        for (r = "", e = 0, v.lR.lastIndex = 0, n = v.lR.exec(g); n; )
          (r += C(g.substring(e, n.index))),
            (t = i(v, n))
              ? ((k += t[1]), (r += u(t[0], C(n[0]))))
              : (r += C(n[0])),
            (e = v.lR.lastIndex),
            (n = v.lR.exec(g));
        return r + C(g.substr(e));
      }
      function c() {
        var t = "string" == typeof v.sL;
        if (t && !M[v.sL]) return C(g);
        var e = t ? L(v.sL, g, !0, b[v.sL]) : A(g, v.sL.length ? v.sL : void 0);
        return (
          0 < v.r && (k += e.r),
          t && (b[v.sL] = e.top),
      ...
      function h(t, e) {
        if (((g += t), null == e)) return f(), 0;
        var n = o(e, v);
        if (n)
          return (
            n.skip
              ? (g += e)
              : (n.eB && (g += e), f(), n.rB || n.eB || (g = e)),
            d(n, e),
            n.rB ? 0 : e.length
          );
        var r = a(v, e);
        if (r) {
          ...
          for (
            i.skip
              ? (g += e)
              : (i.rE || i.eE || (g += e), f(), i.eE && (g = e));
            v.cN && (y += O), v.skip || (k += v.r), (v = v.parent) !== r.parent;

          );
          return r.starts && d(r.starts, ""), i.rE ? 0 : e.length;
        }
        if (s(e, v))
          throw new Error(
            'Illegal lexeme "' +
      ...
      var p = _(t);
      if (!p) throw new Error('Unknown language: "' + t + '"');
      T(p);
      var m,
        v = r || p,
        b = {},
        y = "";
      for (m = v; m !== p; m = m.parent) m.cN && (y = u(m.cN, "", !0) + y);
      var g = "",
        k = 0;
      try {
        for (var w, x, E = 0; (v.t.lastIndex = E), (w = v.t.exec(e)); )
          (x = h(e.substring(E, w.index), w[0])), (E = w.index + x);
        for (h(e.substr(E)), m = v; m.parent; m = m.parent) m.cN && (y += O);
        return { r: k, value: y, language: t, top: v };
      } catch (S) {
        if (S.message && -1 !== S.message.indexOf("Illegal"))
    ...
    function h(t) {
      return q.tabReplace || q.useBR
        ? t.replace(w, function (t, e) {
            return q.useBR && "\n" === t
              ? "<br>"
              : q.tabReplace
              ? e.replace(/\t/g, q.tabReplace)
              : "";
          })
        : t;
    }
    ...
    function e(t) {
      ...
      s(a) ||
        ...
        (t.result = { language: r.language, re: r.r }),
        r.second_best &&
          (t.second_best = {
    ...
    function _(t) {
      return (t = (t || "").toLowerCase()), M[t] || M[y[t]];
    }
    var v = [],
      b = Object.keys,
      M = {},
      y = {},
      g = /^(no-?highlight|plain|text)$/i,
      k = /\blang(?:uage)?-([\w-]+)\b/i,
      w = /((^(<[^>]+>|\t|)+|(?:\n)))/gm,
      O = "</span>",
      q = {
    ...
    return (
      ...
      (i.highlightBlock = e),
      (i.configure = t),
      (i.initHighlighting = r),
      (i.initHighlightingOnLoad = o),
      (i.registerLanguage = a),
      (i.listLanguages = m),
      (i.getLanguage = _),
      (i.inherit = n),
      (i.IR = "[a-zA-Z]\\w*"),
      ...
      (i.RSR =
        "!|!=|!==|%|%=|&|&&|&=|\\*|\\*=|\\+|\\+=|,|-|-=|/=|/|:|;|<<|<<=|<=|<|===|==|=|>>>=|>>=|>=|>>>|>>|>|\\?|\\[|\\{|\\(|\\^|\\^=|\\||\\|=|\\|\\||~"),
      (i.BE = { b: "\\\\[\\s\\S]", r: 0 }),
      (i.ASM = { cN: "string", b: "'", e: "'", i: "\\n", c: [i.BE] }),
      (i.QSM = { cN: "string", b: '"', e: '"', i: "\\n", c: [i.BE] }),
      (i.PWM = {
        b: /\b(a|an|the|are|I'm|isn't|don't|doesn't|won't|but|just|should|pretty|simply|enough|gonna|going|wtf|so|such|will|you|your|they|like|more)\b/,
      }),
      (i.C = function (t, e, n) {
        var r = i.inherit({ cN: "comment", b: t, e: e, c: [] }, n || {});
        return (
          r.c.push(i.PWM),
      ...
      (i.CBCM = i.C("/\\*", "\\*/")),
      (i.HCM = i.C("#", "$")),
      (i.NM = { cN: "number", b: i.NR, r: 0 }),
      (i.CNM = { cN: "number", b: i.CNR, r: 0 }),
      (i.BNM = { cN: "number", b: i.BNR, r: 0 }),
      (i.CSSNM = {
        cN: "number",
        b:
          i.NR +
      ...
      (i.RM = {
        ...
        e: /\/[gimuy]*/,
        i: /\n/,
        c: [i.BE, { b: /\[/, e: /\]/, r: 0, c: [i.BE] }],
      }),
      (i.TM = { cN: "title", b: i.IR, r: 0 }),
      (i.UTM = { cN: "title", b: i.UIR, r: 0 }),
      (i.METHOD_GUARD = { b: "\\.\\s*" + i.UIR, r: 0 }),
      i
    );
  }),
  ...
  (function (t, e) {
    if ("function" == typeof define && define.amd) define(["exports"], e);
      ...
      var n = { exports: {} };
      e(n.exports), (t.vanillaModal = n.exports);
    }
  })(this, function (t) {
    function S(t, e) {
      if (!(t instanceof e))
      ...
      function e(t) {
        S(this, e),
          ...
          this.error
            ...
            : (this._addLoadedCssClass(), this._events().add());
      }
      return (
        C(e, [
          {
          ...
          },
          {
            ...
            value: function n() {
              if (!1 !== this.$$.transitions) {
                ...
                for (var n in e)
                  if (e.hasOwnProperty(n) && t.style[n] !== undefined)
                    return e[n];
              }
            },
          },
          {
            ...
            value: function r(t, e) {
              ...
              return (
                n ||
                ((this.error = !0),
                console.error(t + " not found in document."))
              );
            },
          },
          {
            ...
            value: function i() {
              var t = {};
              return (
                (t.modal = this._getNode(this.$$.modal)),
                (t.page = this._getNode(this.$$.page)),
                (t.modalInner = this._getNode(this.$$.modalInner, this.modal)),
                (t.modalContent = this._getNode(
                  this.$$.modalContent,
                  this.modal
                )),
                t
          ...
          },
          {
            key: "_setOpenId",
            value: function u() {
              var t = this.current.id || "anonymous";
              this.$.page.setAttribute("data-current-modal", t);
            },
          },
          {
            key: "_removeOpenId",
          ...
          },
          {
            ...
            value: function c(t) {
              return t && "string" == typeof t.hash
                ? document.querySelector(t.hash)
                : "string" == typeof t
                ? document.querySelector(t)
                : console.error("No selector supplied to open()");
            },
          },
          {
            key: "_open",
            value: function f(t, e) {
              if (
                (this._releaseNode(),
                (this.current = this._getElementContext(t)),
                this.current instanceof HTMLElement == !1)
              )
                return console.error("VanillaModal target must exist on page.");
              "function" == typeof this.$$.onBeforeOpen &&
                this.$$.onBeforeOpen.call(this, e),
                this._captureNode(),
          ...
          },
          {
            ...
            value: function d() {
              ...
              return !![
                ...
                if ("string" == typeof e[t] && 0 < parseFloat(e[t])) return !0;
              }).length;
            },
          },
          {
            ...
            value: function h(t) {
              if (!0 === this.isOpen) {
                (this.isOpen = !1),
                  "function" == typeof this.$$.onBeforeClose &&
                    this.$$.onBeforeClose.call(this, t),
                  this._removeClass(this.$.page, this.$$["class"]);
                var e = this._detectTransition();
                this.$$.transitions && this.$$.transitionEnd && e
                  ? this._closeModalWithTransition(t)
                  : this._closeModal(t);
              }
            },
          },
          ...
          },
          {
            ...
            value: function m(t) {
              var e = function () {
                this.$.modal.removeEventListener(this.$$.transitionEnd, e),
                  this._closeModal(t);
              }.bind(this);
              this.$.modal.addEventListener(this.$$.transitionEnd, e);
            },
          },
          {
            key: "_captureNode",
            value: function v() {
              if (this.current)
                for (; 0 < this.current.childNodes.length; )
          ...
          },
          {
            ...
            value: function b() {
              if (this.current)
                for (; 0 < this.$.modalContent.childNodes.length; )
          ...
          },
          {
            ...
            value: function y(t) {
              "[object Array]" ===
                Object.prototype.toString.call(this.$$.closeKeys) &&
                0 !== this.$$.closeKeys.length &&
                -1 < this.$$.closeKeys.indexOf(t.which) &&
                !0 === this.isOpen &&
          ...
          },
          {
            ...
            value: function k(t, e) {
              for (
                var n = t.target,
                  r = (n.document || n.ownerDocument).querySelectorAll(e),
                  i = 0;
                i < r.length;
                i++
              )
                for (var o = n; o && o !== document.body; ) {
                  if (o === r[i]) return o;
                  o = o.parentNode;
                }
              return null;
          ...
          },
          {
            key: "_delegateOpen",
            value: function w(t) {
              var e = this._matches(t, this.$$.open);
              if (e)
                return (
                  t.preventDefault(), (t.delegateTarget = e), this.open(e, t)
                );
            },
          },
          {
          ...
          },
          {
            ...
            value: function E() {
              var t = this._closeKeyHandler.bind(this),
                e = this._outsideClickHandler.bind(this),
                n = this._delegateOpen.bind(this),
                r = this._delegateClose.bind(this),
                i = function i() {
    ...
    return (function (n) {
      ...
      function (t, e, n) {
        ...
        (a = function (t, n) {
          ...
          var e,
            i = (e = n) && e.__esModule ? e : { default: e },
            o =
...
var App = function () {
    var c = Object.create(App.prototype),
      t = function () {
        (c.domain = "https://codebeautify.org/"),
          (c.img = IMAGE),
          (c.body = $("body")[0]),
          (c.hover = 0),
          (c.search = $(".js-search")[0]),
          (c.image = $(".js-image")[0]),
          (c.imageInput = $(".js-image-input")[0]),
          (c.title = $(".js-title")[0]),
          (c.titleCount = $(".js-title-count")[0]),
          (c.description = $(".js-description")[0]),
          (c.descriptionCount = $(".js-description-count")[0]),
          (c.code = $(".js-code")[0]),
          (c.codeMin = $(".js-code-min")[0]),
          (c.previewImage = $(".js-preview-image")),
          (c.previewImg = $(".js-preview-img")),
          (c.previewTitle = $(".js-preview-title")),
          (c.previewDescription = $(".js-preview-description")),
          (c.previewDomain = $(".js-preview-domain")),
          (c.favicon = $(".js-preview-favicon")[0]),
          (c.navLink = $(".js-nav-link")),
          v(),
          b();
      },
      e = function () {
        c.search.classList.add("is-active");
      },
      n = debounce(function () {
        var t = this.value;
        o(t);
      ...
      r = function (t) {
        t.preventDefault(), t.stopPropagation(), c.hover, (c.hover = 0);
        var e = t.dataTransfer.files[0];
        l(e);
      },
      i = function (t) {
        t.preventDefault(), t.stopPropagation(), c.hover, (c.hover = 1);
      },
      o = function (e) {
        var t = "/api/metadata?domain=" + e,
      ...
      a = function (t) {
        console.log(t);
        var e = t.title || t["og:title"] || "",
          n = t["og:image"] || "",
          r = t.favicon || "",
          i = t.description || "",
          o = t.url || "",
          a = t["og:site_name"] || t.url || "",
          s = t.size || null;
        if (
          ((c.domain = o),
          (c.img = n),
          (c.image.style.backgroundImage = 'url("' + n + '")'),
          (c.title.value = e),
          (c.titleCount.innerHTML = e.length),
          (c.description.value = i),
          (c.descriptionCount.innerHTML = i.length),
          c.previewImage.forEach(function (t) {
            t.style.backgroundImage = 'url("' + n + '")';
          }),
          c.previewImg.forEach(function (t) {
            t.src = n;
          }),
          c.previewTitle.forEach(function (t) {
            t.innerHTML = e;
          }),
          c.previewDescription.forEach(function (t) {
            t.innerHTML = i;
          }),
          (c.previewDescription[0].innerHTML = truncate(i, 160)),
          (c.previewDomain[0].innerHTML = o),
          (c.previewDomain[1].innerHTML = url_domain(o)),
          (c.previewDomain[2].innerHTML = url_domain(o)),
          (c.previewDomain[3].innerHTML = url_domain(o)),
          (c.previewDomain[4].innerHTML = o),
          ($(".js-preview-site-name")[0].innerHTML = a),
          (c.favicon.src = r),
          s)
        ) {
          var u = (360 * s[1]) / s[0];
          $(".js-slack-image")[0].style.height = u + "px";
        }
        var l = h();
        (c.codeMin.innerHTML = l), hljs.highlightBlock(c.codeMin);
      },
      s = function (t) {
        t.preventDefault();
        var e = this.dataset.type;
        $("#" + e)[0].classList.toggle("is-active"),
      ...
      l = function (t) {
        ...
        (e.onload = function (t) {
          ...
          (c.image.style.backgroundImage = 'url("' + e + '")'),
            c.previewImage.forEach(function (t) {
          ...
          t ? e.readAsDataURL(t) : (preview.src = "");
      },
      f = function () {
        var e = this;
        c.previewTitle.forEach(function (t) {
          ...
          console.log(e.value),
          (c.titleCount.innerHTML = e.value.length),
          h();
      },
      d = function () {
        var e = this;
        c.previewDescription.forEach(function (t) {
          ...
          (c.previewDescription[0].innerHTML = truncate(e.value, 160)),
          (c.descriptionCount.innerHTML = e.value.length),
          h();
      },
      h = function () {
        var t = "";
        return (
          (t += "&lt;title&gt;" + c.title.value + "&lt;/title&gt;<br>"),
          (t +=
      ...
      p = function () {
        var t = "<br>";
        return (
          (t += "&lt;!-- Open Graph / Facebook --&gt;<br>"),
          (t +=
            "&lt;meta property=&quot;og:type&quot; content=&quot;website&quot;&gt<br>"),
          (t +=
      ...
      m = function () {
        ...
        return (
          (t += "&lt;!-- Twitter --&gt;<br>"),
          (t +=
            "&lt;meta property=&quot;twitter:card&quot; content=&quot;summary_large_image&quot;&gt<br>"),
          (t +=
      ...
      v = function () {
        new ClipboardJS(".js-copy").on("success", function () {
          var t = $(".js-copied")[0];
      ...
      b = function () {
        c.body.on("dragover", i),
          c.body.on("dragenter", i),
          c.body.on("drop", r),
          c.search.on("focus", e),
          c.search.on("keyup", n),
          c.navLink.on("click", s),
          c.imageInput.on("change", u),
          c.title.on("keyup", f),
          c.description.on("keyup", d);
      };
    return (
      (c.generateMetaTags = function () {
        var t = "&lt;!-- Primary Meta Tags --&gt;<br>" + h() + p() + m();
        (c.code.innerHTML = t), hljs.highlightBlock(c.code);
      }),
      t(),
      c
    );
  ...
  Generator = function () {
    var i = Object.create(Generator.prototype),
      t = function () {
        (i.state = 2),
          (i.string = "I Drink Till I'M Drunk Smoke Till i high"),
          (i.fontList = $(".js-font-list")[0]),
          (i.text = $(".js-text")[0]),
          i.fonts,
          i.renders,
          (i.preview = $(".js-preview")[0]),
          (i.previewButton = $(".js-preview-button")[0]),
          (i.instagram = $(".js-instagram")[0]),
          (i.twitter = $(".js-twitter")[0]),
          (i.dictionary =
      ...
      e = function () {
        ...
        document
          ...
          .content.querySelector("li");
        dictionary.forEach(function (t, e) {
          var n = document.importNode(r, !0);
          e === i.state && n.classList.add("is-active"),
            (n.querySelector(".js-render").id = "text-" + e),
            (n.querySelector(".js-render-name").textContent = t.name),
            (n.querySelector(".js-copy").dataset.clipboardTarget =
              "#text-" + e),
            i.fontList.appendChild(n);
        }),
          (i.fonts = $(".js-font")),
          (i.renders = $(".js-render")),
          s();
      ...
      n = function () {
        ...
        $(".js-month").forEach(function (t) {
          t.innerHTML = e;
        });
      },
      r = function () {
        i.preview.classList.contains("is-active")
          ? (i.previewButton.querySelector(".js-swap").textContent =
              "\u2191 View")
          : (i.previewButton.querySelector(".js-swap").textContent =
              "\u2193 Close"),
          i.preview.classList.toggle("is-active");
      },
      o = function () {
        i.fonts.forEach(function (t) {
          ...
          (i.state = Array.prototype.indexOf.call(i.fontList.children, this)),
          u();
      },
      a = function () {
        (i.string = this.value), s();
      },
      s = function () {
        var r = new GraphemeSplitter()
          .splitGraphemes(i.string)
          .map(function (t) {
            return 0 <= i.dictionary.indexOf(t) ? i.dictionary.indexOf(t) : t;
          });
        dictionary.forEach(function (e, t) {
          var n = r
            .map(function (t) {
              return e.list[t] ? e.list[t] : t;
            })
            .join("");
          i.renders[t] && (i.renders[t].innerHTML = n);
        }),
          u();
      },
      u = function () {
        var t = i.renders[i.state].innerHTML;
        (i.instagram.innerHTML = t), (i.twitter.innerHTML = t);
      },
      l = function () {
        new ClipboardJS(".js-copy").on("success", function (t) {
          var e = t.trigger.querySelector(".js-copied");
...
if (document.body.classList.contains("index")) {
  var app = new App(),
    modal = new VanillaModal({
      ...
      onOpen: function () {
        app.generateMetaTags();
      },
    });
  hljs.initHighlightingOnLoad();
  var mini = $(".js-mini")[0],
    miniClose = $(".js-mini-close")[0],
    loadMini = function () {
      setTimeout(function () {
        mini.classList.add("is-active");
      }, 2e3);
    },
    setMiniClose = function (t) {
      t.preventDefault(), mini.classList.remove("is-active");
    };
}
